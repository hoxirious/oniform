...
const initToolbar = () => {
  const clipboardButton = new ActionButton(
    "Clipboard",
    () => {
  ...
  const previewButton = new ActionButton(
    "Preview",
    () => {
      const previewElement = document.getElementById("preview-window");
      const clipboardElement = document.getElementById("clipboard-window");
  ...
  const libraryButton = new ActionButton(
    "Library",
    () => {
      const previewElement = document.getElementById("preview-window");
      const clipboardElement = document.getElementById("clipboard-window");
...
const initPage = () => {
  ...
  toolbarVnode = patch(
    toolbar,
    h("div#toolbar", [...initToolbar(), Tree.instance.render()]),
  );
  initForm();
};
